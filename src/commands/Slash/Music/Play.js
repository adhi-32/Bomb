    ...
    run: async (client, interaction) => {
        ...
        if (player && interaction.member.voice.channelId !== interaction.guild.members.me.voice.channelId) {
            const embed = new EmbedBuilder()
                ...
                .setDescription(`<:tick:1107331304325926922> | You must be on the same voice channel as mine to use this command.`)
                .setTimestamp();
        ...
        if (loadType === "PLAYLIST_LOADED") {
            ...
            const embed = new EmbedBuilder()
                .setColor(client.color)
                .setDescription(`<:tick:1107331304325926922> | **[${playlistInfo.name}](${song})** • \`${tracks.length}\` tracks • ${track.info.requester}`);
            ...
            const embed = new EmbedBuilder()
                .setColor(client.color)
                .setDescription(
                    `<:tick:1107331304325926922> | **[${track.info.title ? track.info.title : "Unknown"}](${track.info.uri})** • \`${
            ...
            const embed = new EmbedBuilder().setColor(client.color).setDescription(`<:wrong:1107334083404648589> | Song was no found or Failed to load song!`);
