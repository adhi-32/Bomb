...
module.exports.run = async (client, message) => {
    ...
    if (message.content.match(mention)) {
        const embed = new EmbedBuilder().setColor(client.color).setDescription(`**<:emoji_14:1127621045508124772>__BOT OWNER__**
[bomb_xd#0000](https://discord.com/users/978133070387478639)
  **__HEY IAM NEON My prefix /__**`);
